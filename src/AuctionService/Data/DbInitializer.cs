...
namespace AuctionService.Data
{
	...
	{
		//	chỗ này dùng OnModelCreating seed data vào cũng được

		//	đoạn lệnh này sẽ chạy sau khi add service AuctionDbContext
		//	nhưng trước khi application run
		//	để inject service vào class trước cả khi application run thì phải tạo scope
		//	create scope để access vào service AuctionDbContext 
		//	rồi dùng nó để seed data vào
		//	using để diposed tất cả service trong scope sau khi dùng xong
		...
		private static void SeedData(AuctionDbContext context)
		{
			...
			{
				Console.WriteLine("Already have data - No need to set");
				return;
			}
